...
static int synaptics_rmi4_parse_dt(struct device *dev, struct synaptics_dsx_platform_data *pdata)
{
	...
	*/
	...
	/* DTS2014090101734  caowei 201400902 end >*/
	/* DTS2014080506603  caowei 201400806 end >*/
    	/* < DTS2014120505073 zhoumin wx222300 20141208 begin */
     	pdata->low_power_support = (bool)get_of_u32_val(np, "synaptics,support_low_power_model", 0);
    	/* DTS2014120505073 zhoumin wx222300 20141208 end >*/
...
void synaptics_dsx_hardware_reset(struct synaptics_rmi4_data *rmi4_data)
{
	...
	if (!cdev){
        ...
        /* BEGIN PN:DTS2014101006200,Added by yuanbo, 2014/10/11*/
        enable_irq(rmi4_data->irq);
        /* END   PN:DTS2014101006200,Added by yuanbo, 2014/10/11*/  
		return;
	}

	...
	if (!gpio_get_value(pn547_dev->irq_gpio)) {
		if (filp->f_flags & O_NONBLOCK) {
			...
			goto fail;
              ...
              /* < DTS2014102503478  jiaboyang 20141025 Begin */
		//pr_info("Waiting for PN547 IRQ.\n");
              /* DTS2014102503478  jiaboyang 20141025 End > */

		/* < DTS2014082603019  zhugang/WX222714 20140826 begin */
		pn547_dev->do_reading = 0;
		pn547_enable_irq(pn547_dev);
		/* DTS2014082603019  zhugang/WX222714 20140826 end > */
...
/* < DTS2015010707762 yanhong/00202429 20150107 begin */
/* delete pn547 check function */

/* DTS2015010707762 yanhong/00202429 20150107 end > */
...
/* < DTS2014061802186 songxiaoming 20140625 begin */
...
/* DTS2014061802186 songxiaoming 20140625 end > */
err_clk_req:
		...
		const struct i2c_device_id *id)
{
	...
	/* < DTS2014112200393 yanhong/00202429 20141122 begin */
    /* < DTS2015012006366 yanhong/00202429 20150120 begin */
    #ifdef CONFIG_HUAWEI_DSM
	if(!nfc_dclient){
	   nfc_dclient = dsm_register_client (&dsm_nfc);
	}
    #endif	
    /* DTS2015012006366 yanhong/00202429 20150120 end > */

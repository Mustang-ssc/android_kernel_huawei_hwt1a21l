...
/* < DTS2014122909056 tanyanying 20141229 begin */
...
#endif
/* DTS2014122909056 tanyanying 20141229 end > */
...
static int get_prop_batt_status(struct qpnp_lbc_chip *chip)
{
	...
	if (rc) {
		...
		/* <DTS2014120901568  jiangfei 20141209 begin */
#ifdef CONFIG_HUAWEI_KERNEL
		return POWER_SUPPLY_STATUS_UNKNOWN;
#else
		return POWER_SUPPLY_CHARGE_TYPE_NONE;
#endif
		/* DTS2014120901568  jiangfei 20141209 end> */
	}
				       ...
				       union power_supply_propval *val)
{
	...
	switch (psp) {
	case POWER_SUPPLY_PROP_STATUS:
	/* < DTS2014112402977 taohanwen 20141207 begin */
		if (chip->use_other_charger &&
		...
		break;
	/* DTS2014112402977 taohanwen 20141207 end > */
...
#endif
		/* DTS2014102005552 taohanwen 20141008 end > */
		break;
	case POWER_SUPPLY_PROP_HOT_IBAT_LIMIT:
		/* <DTS2014112902817 taohanwen 20141129 begin */
        /* < DTS2015011506075 zhaoxiaoli 20150115 begin */
...
static void monitor_soc_jump_when_usbinirq_invoke(struct qpnp_lbc_chip *chip)
{
	...
	if((HALF_MINUTE >= (now_tm_sec - usbin_start_tm_sec))
        ...
        /* DTS2015011506075 zhaoxiaoli 20150115 end > */
		/* < DTS2015012009827 taohanwen 20150120 begin */
		if(cur_capacity >= 0 && abs(cur_capacity - prev_capacity) > SOC_JUMP_USBIN){

...
/* < DTS2014092004941 chenxi 20140922 begin */
...
#endif
/* DTS2014092004941 chenxi 20140922 end > */


/* < DTS2014062507748 zengfengming 20140626 begin */
#ifdef CONFIG_HUAWEI_FEATURE_DIAG_MDLOG
...
#endif
/* DTS2014062507748 zengfengming 20140626 end > */
...
void diag_smd_send_req(struct diag_smd_info *smd_info)
{
	...
	if (smd_info->ch && buf) {
		...
		/* < DTS2014102905332 nieyufeng WX229492 sync qualcomm CR 746117 20141030 begin */
		if (smd_info->type == SMD_CMD_TYPE
		...
		if ((smd_info->type != SMD_CNTL_TYPE) || buf_full)
			break;
		/* DTS2014102905332 nieyufeng WX229492 sync qualcomm CR 746117 20141030 end > */

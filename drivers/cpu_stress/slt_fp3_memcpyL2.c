...
#define DECLARE_SLT_CPU_MEMCPYL2_DRV(_N)                 \
static struct device_driver slt_cpu##_N##_memcpyL2_drv = \
{                                                        \
    .name  = "slt_cpu"#_N"_memcpyL2",                    \
    .bus   = &platform_bus_type,                         \
    .owner = THIS_MODULE,                                \
};

DECLARE_SLT_CPU_MEMCPYL2_DRV(0)
DECLARE_SLT_CPU_MEMCPYL2_DRV(1)
DECLARE_SLT_CPU_MEMCPYL2_DRV(2)
DECLARE_SLT_CPU_MEMCPYL2_DRV(3)
DECLARE_SLT_CPU_MEMCPYL2_DRV(4)
DECLARE_SLT_CPU_MEMCPYL2_DRV(5)
DECLARE_SLT_CPU_MEMCPYL2_DRV(6)
DECLARE_SLT_CPU_MEMCPYL2_DRV(7)
